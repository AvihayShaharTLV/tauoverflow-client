...
const discussions = [
    {
        ...
        title: "מה עושים אם יש לי בולבול ממש קטן?",
        text: "חברה שלי אומרת שיש לי בולבול ממש קטן ואני לא יודע מה לעשות. טיפים?",
    ...
    },
    {
        ...
        title: "כואב לי בתחת לשבת על הכיסא כבר. כרית מישהו?",
        text: "",
        date: new Date().toUTCString().replace('GMT', ""),
        likes: ['user1', 'user2', 'user3', 'user4'],
        replies: [
    ...
    },
    {
        ...
        text: "נשבע נודר באמא של מישהו כאן לא שלי",
        date: new Date().toUTCString().replace('GMT', ""),
        likes: ['user1', 'user2', 'user3'],
        replies: [
            {
